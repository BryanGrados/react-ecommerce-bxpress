        ...
        <section className="text-gray-600 dark:text-gray-300">
            <div className="container flex flex-wrap items-center py-24">
                <div className="pr-0 lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0">
                    <h1 className="text-3xl font-medium text-black title-font dark:text-white">Subscribe to our newsletter</h1>
                ...
                <div className="flex flex-col w-full p-8 mt-10 border border-gray-400 rounded-lg lg:w-2/6 md:w-1/2 bg-slate-200 dark:bg-amber-500 dark:border-black md:ml-auto md:mt-0">
